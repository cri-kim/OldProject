...
<title><spring:message code="runtime6.infor" /></title>
...
thead {
   ...
   BORDER-RIGHT: #DEB84F 1px solid;
   BORDER-TOP: #DEB84F 1px solid;
   BORDER-LEFT: #DEB84F 1px solid;
   BORDER-BOTTOM: #DEB84F 1px solid
}
...
function facheck(fa){
   ...
   $(function() {
      ...
      $("input[name=cancle]").bind('click', function() {
   ...
   function search() {
      ...
      $
            .post(
                  "<spring:url value="/mypage/search" />",
                  $("#searchForm").serialize(),
                  function(result) {
                     $("input[name=force_withdraw]")
                           .bind(
                                 'click',
                                 function() {
                                    ...
                                    if ($(":checked").length == 0) {
                                       ...
                                       $
                                             .ajax({
                                                url : '<spring:url value="/mypage/forcedUser" />',
                                                data : $(
                                                      "#mypageForm")
                                                      .serialize(),
                                                type : 'PUT',
                                                success : function(
                                                   ...
                                                   alert(validation
                                                         .getMessage(
                                                               code,
                                                               [ 'label_delete_userInfo' ]));
                                                   window.location.href = "<spring:url value="/mypage/infor" />";
                                                },
                                                error : function(
                                                      jqXHR,
                                                      textStatus,
                                                      errorThrown) {
                                                   alert(validation
                                                         .getMessage('msg_alert_error_general'));
                                                }
                                             });
                                    }
   ...
   <div class="page">
      ...
      <div class="body">
         <div class="home">
            ...
            <div class="section">
               <center>
                  <font color="gray" size="5"><h1>Runtime6 회원 목록</h1></font>
               </center>
            </div>
            <div>
               <table align="center" style="width: 860px">
                  <thead style="font-size: 20px">
                     <tr
                        ...
                        <td height='50px'></td>
                        <td width="95px"><b>탈퇴여부</b></td>
                        <td width="85px"><b>&nbsp;&nbsp;&nbsp;&nbsp;구분&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>아이디</b></td>
                        <td><b>이름</b></td>
                        <td><b>연락처</b></td>
                        <td width="220px"><b>&nbsp;&nbsp;&nbsp;주소&nbsp;&nbsp;&nbsp;</b></td>
                     </tr>
               ...
               <table align="right">
                  <tr align="right">
                     <td align="center"><input type="button"
                        name="force_withdraw" id="force_withdraw"
                        value="<spring:message code="label.forcewithdraw" />" /></td>
                     <td align="center"><input type="button" name="cancle"
                        id="cancle" value="<spring:message code="label.cancel" />" /></td>
                  </tr>
               </table>

               <form name="mypageForm" id="mypageForm" method="POST"
                  encType="multipart/form-data"
                  action='<spring:url value="/mypage/forcedUser" />'>
                  <input type="hidden" name="enabled" id="enabled" value="0" /> <input
