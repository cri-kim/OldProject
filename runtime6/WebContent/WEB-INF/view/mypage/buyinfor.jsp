...
<title><spring:message code="runtime6.buyinfor" /></title>
...
function basong(ba){
    var b =window.open("",""," width=720,height=790", "resizeable=no");
    b.document.open();
    b.document.write("<html><title>배송정보</title><body><img src='<spring:url value='../../"+ba+"' />' /><body></html>");
    b.document.close();
 }
$(function() {	
...
$.post("<spring:url value="/mypage/buylist" />",
...
$(result.buyList).each(function(index, join) {
		var $tr = $("<tr align='center' style='cursor:pointer;'>");
			var loc=(join.p_dttm).split("-");
		     ...
		     $tr.append($("<td>").append(
		             join.p_dttm));
		     $tr.append($("<td>").append($("<input type='button' value='조회' id='"+index+"'>")));
		     $("#buyList").append($tr);

	
		     $("input[id='"+index+"']").bind('click',function(){
		    	 basong('images/basong.jpg');
		    	 /* alert("배송번호:"+join.d_id+" 입니다");
		 		 if(confirm("배송조회를 위해서 배송업체로 이동하시겠습니까?")){
		 			window.location.href="http://www.doortodoor.co.kr/";
		 		 } */
		 	});	
...
<div class="page">
      <div class="header">
         ...
         <div class="home">
            ...
            <div class="section">
               <center>
                  <font color="gray" size="5"><h1><c:out value="${userInfo.username}"/>님의 구매목록</h1></font>
               </center>
            </div>
            <div>
               ...
               <tr align="center" id="pagingArea"
                     style="font-size: 20px; color: #5D5D5D;">
               </tr>
               </table>
