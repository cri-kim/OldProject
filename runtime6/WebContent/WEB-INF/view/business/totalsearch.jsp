...
function search(i) {
		...
		if(i == 0){
			...
			var tmp=$("input[name='searchCondition']:checkbox:checked").val();
			$array4=tmp + '/' +$("input[name=searchText]").val(); 
			if(tmp == undefined){
				var $tmp1=null;
				var $tmp2=null;
				$array4= $tmp1 + '/' + $tmp2;
		...
		$.post("<spring:url value="/business/search1/" />"+$array4,
